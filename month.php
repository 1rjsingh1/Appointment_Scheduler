...
<html lang="en" dir="ltr">
  ...
  <body>
      <div class="container" style="margin-left:16%;">
        <div class="heading" style="text-align: center; "><h3><span data-feather="plus-circle"></span> This Month</h3></div>
     ...
     booking.idp=".$idp." and doctors.idd=booking.idd and date like ('%$cm%')";
