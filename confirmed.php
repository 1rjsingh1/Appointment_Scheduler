<?php
    ...
    $idd=$_COOKIE['doc_id'];
      $idp=$_COOKIE['pa_id'];
        ...
        mail($res['email'],"Appointment Booking","Your appointment with ".$res['dname']." has been CONFIRMED dated : ".$date.
            " at".$res['time'].". You are requested to arrive at the appropriate timings.");
