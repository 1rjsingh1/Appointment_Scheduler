...
<html lang="en" dir="ltr">
  ...
  <body>
      <div class="container" style="margin-left:16%;">
        <div class="heading" style="text-align: center; "><h3><span data-feather="plus-circle"></span> Past Appointments</h3></div>
...
$count=mysqli_num_rows($result);
 ...
 if($count>0){
  ...
  while($fetch=mysqli_fetch_assoc($result)){
    $ajdate=strtotime(date("Y-m-d"));
    $bdate=strtotime($fetch['date']);
    if($bdate<$ajdate)
    {
			echo "<tr>";
